...
const index = () => {
  ...
  return (
    <Box minHeight="100vh">
      ...
      <Box ml={2}>
        <BackHeader headingOne={t('YOUTHNET_DASHBOARD.VILLAGES_AND_YOUTH')} />
      </Box>
      <Box sx={{ width: '100%' }}>
        {value && (
          <Tabs
          ...
          >
            <Tab value={1} label={t('YOUTHNET_DASHBOARD.VILLAGES')} />
            <Tab value={2} label={t('YOUTHNET_DASHBOARD.YOUTH_VOLUNTEERS')} />
          </Tabs>
        )}
      </Box>
          ...
          <>
            ...
            >
              <SearchBar
                ...
                value={searchInput}
                placeholder={t('YOUTHNET_DASHBOARD.SEARCH_VILLAGES')}
                fullWidth={false}
              />
              <SortBy />
            </Box>
            ...
            >
              <UserList layout="grid" users={villageList} />
            </Box>
          </>
        )}
      </Box>
